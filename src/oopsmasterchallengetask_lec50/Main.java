...
public class Main {
	...
	public static void main(String[] args) {
		...
		Hamburger hm =new Hamburger("Meat","Wholewheet",2.99);
		hm.accees();
		Healthyhamburger hb = new Healthyhamburger();
		System.out.println("Do you want healthy hamburger. Press Y for Yes.");
		//healthyhamburger();
		//Healthyhamburger hb = new Healthyhamburger();
